...
import pytest
from curve_fx_sim.artifacts.attestation import resolve_attested_file, verify_manifest_artifacts
from curve_fx_sim.artifacts.io import sha256_path
from curve_fx_sim.artifacts.manifest import ManifestError, load_manifest, new_grid_manifest, write_manifest_atomic
...
def test_manifest_artifact_and_path_tamper_table(tmp_path: Path) -> None:
    artifact = {
